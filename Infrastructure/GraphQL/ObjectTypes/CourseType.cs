...
public class CourseType : ObjectType<CourseEntity>
{
	...
	public class ProgramDetailItemType : ObjectType<ProgramDetaiItemEntity>
	{
		protected override void Configure(IObjectTypeDescriptor<ProgramDetaiItemEntity> descriptor)
		{
